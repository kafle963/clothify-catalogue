    ...
    <nav className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Search Bar */}
          <div className="hidden lg:flex items-center relative max-w-md xl:max-w-lg 2xl:max-w-xl flex-1 mx-6 xl:mx-10">
            <form onSubmit={handleSearch} className="w-full relative">
              <div className="flex group cursor-pointer transition-all duration-300 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] focus-within:scale-[1.02] focus-within:shadow-xl rounded-lg overflow-hidden">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-9 pr-3 bg-muted/50 border-0 focus:bg-background focus:shadow-none transition-all duration-300 hover:bg-muted/80 group-hover:bg-muted/80 group-focus-within:bg-background rounded-r-none text-sm xl:text-base h-10 xl:h-11"
                  />
                </div>
                <Button 
                  type="submit" 
                  size="sm"
                  className="bg-accent hover:bg-accent/80 text-accent-foreground px-3 xl:px-4 py-2 rounded-l-none h-10 xl:h-11 transition-all duration-300 group-hover:bg-accent/85 group-focus-within:bg-accent/85"
                >
        ...
        <div className="lg:hidden border-t bg-background/95 backdrop-blur">
          <div className="container mx-auto px-4 py-4 space-y-4">
            ...
            <form onSubmit={handleSearch} className="">
              <div className="flex gap-2 group transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] focus-within:scale-[1.01]">
                <div className="relative flex-1">
                  <Search className="absolute left-3 h-4 w-4 top-3 text-muted-foreground transition-all duration-300 group-hover:text-accent group-focus-within:text-accent" />
                  <Input
                    placeholder="Search for products, brands, categories..."
                    value={searchQuery}
                    onChange={(e) => handleSearchChange(e.target.value)}
                    className="pl-9 bg-muted/50 border-0 focus:bg-background focus:shadow-none transition-all duration-300 hover:bg-muted/80 group-hover:bg-muted/80 group-focus-within:bg-background h-11"
                  />
                </div>
                <Button type="submit" size="sm" className="bg-accent hover:bg-accent/80 text-accent-foreground h-11 px-4 transition-all duration-300 group-hover:bg-accent/85 group-focus-within:bg-accent/85">
                  <Search className="h-4 w-4" />
                </Button>
              </div>
            </form>
